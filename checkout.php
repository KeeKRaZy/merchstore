...
<body onload="cartLength();">
    ...
    <header>
        <nav>
            <ul>
                ...
                <li><a href="index.php"><h1>CHECKOUT</h1></a></li>
                <li>
    ...
    <div class="changeYourData">
        <form method="POST" onsubmit="return validationCheck()">
            <ul class="doubleLi"><li>Name</li><li>Surname</li></ul>
            <div> 
                <input id="userNameInsideInput" type="text" name="name" minlength="2" maxlength="15" required placeholder="Enter your name">
                <input type="text" id="secondShortInput" name="surname" minlength="2" maxlength="15" required placeholder="Enter your surname">
            </div>
            <li>E-mail</li>
            <input id="emailInsideInput" class="longInput" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,4}"  minlength="5" maxlength="49" required placeholder="Enter your e-mail">
            ...
            <input id="updateButton" type="submit" name="button" value="Confirm">
            <p id="payFooter"></p>
        </form>
    </div>
    </main>
...
if (isset($_POST['button'])) {
    echo'<script>
            swal({
                title: "Success!",
                text: "Your order has been accepted, detailed information has been sent to your email address.",
                icon: "success",
            })
            .then((value) => {
